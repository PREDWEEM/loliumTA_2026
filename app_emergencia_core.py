...
if logo_path.is_file():
    ...
    st.sidebar.caption("Motor predictivo Lolium — Tres Arroyos")
...
w_max_val = st.sidebar.number_input("Cap. de Campo Superficial (mm)", value=18.816, step=1.0)
...
if df_meteo_raw is not None and modelo_ann is not None:
    ...
    df, idx_primer_pico, ke_val, mod_termico = simular_emergencia_ta(
        df_meteo_raw,
        modelo_ann,
